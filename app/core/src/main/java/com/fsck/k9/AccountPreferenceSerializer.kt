...
class AccountPreferenceSerializer(
    ...
    fun loadAccount(account: Account, storage: Storage) {
        ...
        with (account) {
            ...
            displayPreference = getEnumStringPref<Account.DisplayPreference>(storage, "$accountUuid.displayPreference", Account.DisplayPreference.HTML_PREFERRED)
    ...
    fun loadDefaults(account: Account) {
        with (account) {
            ...
            displayPreference = Account.DisplayPreference.HTML_PREFERRED
